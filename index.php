    ...
    <div class="container">
		<div id="wrapper">
			...
			?>
				...
				<input type="email" class="input-block-level form-control" placeholder="Email address" name="txtemail" required autofocus=""/>
				...
				<!--<a href="signup.php" style="float:right;" >Sign Up ></a><hr />-->
